...
Java class TimeTerrainLOS
Runs the Wang viewshed algorithm for n times, where n is the number of nodes. Outputs
the total time to complete the algorithm broken down into time to load the height 
map and the time it takes to generate the LOS maps.
...
public class TimeTerrainLOS {
  
  public static void printUsage() {
    System.out.println("Correct Usage:");
    System.out.println("  java TimeTerrainLOS hgtPath ew sw eo so nodes");
  }
  ...
  public static void main(String[] args) {
    ...
    int[] xloc = new int[nodes];
    int[] yloc = new int[nodes];
    Random rand = new Random(); 
    
    // Generate random locations for each node
    for(int i = 0; i < nodes; i++) {
      xloc[i] = rand.nextInt(ew);
      yloc[i] = rand.nextInt(sw);
    }
    ...
    System.out.println("Nodes: " + nodes + ", Area: " + ew*sw + ", Total Time: " + totalTime + ", Terrain Creation: " + terrainCreation + ", Node LOS Calculations: " + nodeCalculation);
  }
